...
# For any questions, don't hesitate to contact me: Ding Zou (dingzou@hust.edu.cn)
...
from modules.KGTN import Recommender
...
def ctr_eval(model, data):
    ...
    while start < data.shape[0]:
        ...
        _, scores, _, _ = model(batch, training=False)
...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        while s + args.batch_size <= len(train_cf):
            ...
            batch_loss, _, _, _ = model(batch, training=True)
